...
import { MoreVertical, Users, CheckSquare, Archive, Trash2, Settings } from "lucide-react";
import {
    DropdownMenu,
    DropdownMenuContent,
    DropdownMenuItem,
...
export default function ProjectCard({ project, onArchive, onDelete }: ProjectCardProps) {
    ...
    const progressPct =
        project.taskCount === 0
            ? 0
            : Math.round((project.tasksCompleted / project.taskCount) * 100);

    return (
        <div className="bg-primary-foreground rounded-lg border border-border/50 overflow-hidden hover:border-border transition-colors group flex flex-col">
            {/* Color accent bar */}
                ...
                <div className="flex items-start justify-between gap-2">
                    ...
                    <DropdownMenu>
                        <DropdownMenuTrigger asChild>
                            <button className="p-1 rounded-md text-muted-foreground opacity-0 group-hover:opacity-100 hover:text-foreground hover:bg-muted transition-all shrink-0">
                ...
                <div className="flex items-center justify-between pt-2 border-t border-border/50">
                    ...
                    <div className="flex items-center gap-1.5">
                        <div className="flex -space-x-1.5">
                            <Avatar className="w-6 h-6 border-2 border-primary-foreground">
                            ...
                            {project.memberCount > 1 && (
                                <div className="w-6 h-6 rounded-full bg-muted border-2 border-primary-foreground flex items-center justify-center">
